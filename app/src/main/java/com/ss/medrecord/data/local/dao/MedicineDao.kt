...
interface MedicineDao {
     ...
     */
    @Query("SELECT * FROM medicines WHERE sync_status = 'CONFLICT'")
    suspend fun getConflicts(): List<MedicineEntity>
    ...
    suspend fun getPurgeable(cutoff: Long): List<MedicineEntity>

    @Query("DELETE FROM medicines WHERE medicine_id = :medicineId")
    suspend fun hardDelete(medicineId: String)
}
